const projects = [
  {
    ...
    description: {
      ko: `90*50mm 또는 85*55mm는 물론 규격의 근사치 조차 따르지 않은, 명함이라 불리지만 주고 받을 수 없는, 네 개의 모서리를 가진 작은 널빤지에 불과한 이것을 내밀었을 때 받는 이들의 반응을 상상한다. 웃거나 당황하거나 가지고 싶다거나 화를 내거나. 
      
이걸 명함이라고 만드신 건가요? 전화번호는요? 메일 주소는 지예님 게 아니던데요? 제가 가지고 갈 수도 없잖아요. 곤란하게 됐습니다. 명함이 점점 자라나서요. 절대 작아지지 않아요. 대신 다가오는 여름을 맞아 땀을 식히는 부채로 쓴다거나 햇빛 가리개로 쓴다거나 길바닥에 앉고 싶을 때 간이 방석으로 사용할 수 있습니다. 꽤 유용하게 쓰일지도 몰라요.`,
      en: "."
    },
    images: [
