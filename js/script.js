...
이걸 명함이라고 만드신 건가요? 전화번호는요? 메일 주소는 지예님 게 아니던데요? 제가 가지고 갈 수도 없잖아요. 곤란하게 됐습니다. 제 명함은 점점 자라나는데 절대 작아지지 않아요. 대신 다가오는 여름을 맞아 땀을 식히는 부채로 쓴다거나 햇빛 가리개로 쓴다거나 가끔 길바닥에 앉고 싶을 때 간이 방석으로 사용할 수 있습니다. 꽤 유용하게 쓰일지도 몰라요.`,
      en: "."
    },
    images: [
