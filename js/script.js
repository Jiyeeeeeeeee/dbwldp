...
엠비언트에 가까운 음악을 들었던 작년 여름과 가을에 일본의 전자 음악가 레이 하라카미를 알게 되었고, 서신교환의 첫 활동으로 하라카미의 측근과 진행한 인터뷰 전문의 한국어 번역과 그의 음악에 대한 나의 생각과 사랑을 담은 팬진을 만들고자 했다. 의지가 무색하게 작년 중 가장 바빴던 시기와 서신교환의 활동 시기가 맞물려 구글의 알고리즘이 선별한 콘텐츠와 이미지로 내용을 구성한 점은 아쉽지만 무언가를 만들고자 하는 마음 하나면 완성도나 퀄리티는 중요하지 않은 것이 진을 만드는 정신이거늘.. 진은 강박이 없는 추상적 개념이며 가능성이다. `,
      en: "To be updated."
    },
    images: [
